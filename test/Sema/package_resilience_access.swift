...
// CLIENT-COMMON-LABEL: // %0 "arg"                                       // users: %2, %1
// CLIENT-COMMON-LABEL: bb0(%0 : $FrozenPublicStruct):
// CLIENT-COMMON-LABEL:   debug_value %0 : $FrozenPublicStruct, let, name "arg", argno 1 // id: %1
// CLIENT-COMMON-LABEL:   %2 = struct_extract %0 : $FrozenPublicStruct, #FrozenPublicStruct.data // user: %3
// CLIENT-COMMON-LABEL:   return %2 : $Int                                // id: %3
...
// CLIENT-RES-NEXT: // %0 "$return_value"                             // user: %6
// CLIENT-RES-NEXT: // %1 "arg"                                       // users: %4, %2
// CLIENT-RES-NEXT: bb0(%0 : $*T, %1 : $*PkgStructGeneric<T>):
// CLIENT-RES-NEXT:   debug_value %1 : $*PkgStructGeneric<T>, let, name "arg", argno 1, expr op_deref // id: %2
// CLIENT-RES-NEXT:   %3 = alloc_stack $PkgStructGeneric<T>           // users: %8, %7, %6, %4
// CLIENT-RES-NEXT:   copy_addr %1 to [init] %3 : $*PkgStructGeneric<T> // id: %4
// CLIENT-RES-NEXT:   // function_ref PkgStructGeneric.data.getter
// CLIENT-RES-NEXT:   %5 = function_ref @$s5Utils16PkgStructGenericV4dataxvg : $@convention(method) <τ_0_0> (@in_guaranteed PkgStructGeneric<τ_0_0>) -> @out τ_0_0 // user: %6
// CLIENT-RES-NEXT:   %6 = apply %5<T>(%0, %3) : $@convention(method) <τ_0_0> (@in_guaranteed PkgStructGeneric<τ_0_0>) -> @out τ_0_0
// CLIENT-RES-NEXT:   destroy_addr %3 : $*PkgStructGeneric<T>         // id: %7
// CLIENT-RES-NEXT:   dealloc_stack %3 : $*PkgStructGeneric<T>        // id: %8
// CLIENT-RES-NEXT:   %9 = tuple ()                                   // user: %10
// CLIENT-RES-NEXT:   return %9 : $()                                 // id: %10
...
// CLIENT-NONRES-NEXT: // %0 "$return_value"                             // user: %4
// CLIENT-NONRES-NEXT: // %1 "arg"                                       // users: %3, %2
// CLIENT-NONRES-NEXT: bb0(%0 : $*T, %1 : $*PkgStructGeneric<T>):
// CLIENT-NONRES-NEXT:   debug_value %1 : $*PkgStructGeneric<T>, let, name "arg", argno 1, expr op_deref // id: %2
// CLIENT-NONRES-NEXT:   %3 = struct_element_addr %1 : $*PkgStructGeneric<T>, #PkgStructGeneric.data // user: %4
// CLIENT-NONRES-NEXT:   copy_addr %3 to [init] %0 : $*T                 // id: %4
// CLIENT-NONRES-NEXT:   %5 = tuple ()                                   // user: %6
// CLIENT-NONRES-NEXT:   return %5 : $()                                 // id: %6
...
// CLIENT-RES-NEXT:   debug_value %1 : $*PkgStructWithPublicExistential, let, name "arg", argno 1, expr op_deref // id: %2
// CLIENT-RES-NEXT:   %3 = alloc_stack $PkgStructWithPublicExistential // users: %8, %7, %6, %4
// CLIENT-RES-NEXT:   copy_addr %1 to [init] %3 : $*PkgStructWithPublicExistential // id: %4
// CLIENT-RES-NEXT:   // function_ref PkgStructWithPublicExistential.member.getter
// CLIENT-RES-NEXT:   %5 = function_ref @$s5Utils30PkgStructWithPublicExistentialV6memberAA0E5Proto_pvg : $@convention(method) (@in_guaranteed PkgStructWithPublicExistential) -> @out any PublicProto // user: %6
// CLIENT-RES-NEXT:   %6 = apply %5(%0, %3) : $@convention(method) (@in_guaranteed PkgStructWithPublicExistential) -> @out any PublicProto
// CLIENT-RES-NEXT:   destroy_addr %3 : $*PkgStructWithPublicExistential // id: %7
// CLIENT-RES-NEXT:   dealloc_stack %3 : $*PkgStructWithPublicExistential // id: %8
// CLIENT-RES-NEXT:   %9 = tuple ()                                   // user: %10
// CLIENT-RES-NEXT:   return %9 : $()                                 // id: %10
...
// CLIENT-NONRES-NEXT:   debug_value %1 : $*PkgStructWithPublicExistential, let, name "arg", argno 1, expr op_deref // id: %2
// CLIENT-NONRES-NEXT:   %3 = struct_element_addr %1 : $*PkgStructWithPublicExistential, #PkgStructWithPublicExistential.member // user: %4
// CLIENT-NONRES-NEXT:   copy_addr %3 to [init] %0 : $*any PublicProto   // id: %4
// CLIENT-NONRES-NEXT:   %5 = tuple ()                                   // user: %6
// CLIENT-NONRES-NEXT:   return %5 : $()                                 // id: %6
...
// CLIENT-RES-NEXT:   debug_value %1 : $*PkgStructWithPkgExistential, let, name "arg", argno 1, expr op_deref // id: %2
// CLIENT-RES-NEXT:   %3 = alloc_stack $PkgStructWithPkgExistential   // users: %8, %7, %6, %4
// CLIENT-RES-NEXT:   copy_addr %1 to [init] %3 : $*PkgStructWithPkgExistential // id: %4
// CLIENT-RES-NEXT:   // function_ref PkgStructWithPkgExistential.member.getter
// CLIENT-RES-NEXT:   %5 = function_ref @$s5Utils013PkgStructWithB11ExistentialV6memberAA0B5Proto_pvg : $@convention(method) (@in_guaranteed PkgStructWithPkgExistential) -> @out any PkgProto // user: %6
// CLIENT-RES-NEXT:   %6 = apply %5(%0, %3) : $@convention(method) (@in_guaranteed PkgStructWithPkgExistential) -> @out any PkgProto
// CLIENT-RES-NEXT:   destroy_addr %3 : $*PkgStructWithPkgExistential // id: %7
// CLIENT-RES-NEXT:   dealloc_stack %3 : $*PkgStructWithPkgExistential // id: %8
// CLIENT-RES-NEXT:   %9 = tuple ()                                   // user: %10
// CLIENT-RES-NEXT:   return %9 : $()                                 // id: %10
...
// CLIENT-NONRES-NEXT:   debug_value %1 : $*PkgStructWithPkgExistential, let, name "arg", argno 1, expr op_deref // id: %2
// CLIENT-NONRES-NEXT:   %3 = struct_element_addr %1 : $*PkgStructWithPkgExistential, #PkgStructWithPkgExistential.member // user: %4
// CLIENT-NONRES-NEXT:   copy_addr %3 to [init] %0 : $*any PkgProto      // id: %4
// CLIENT-NONRES-NEXT:   %5 = tuple ()                                   // user: %6
// CLIENT-NONRES-NEXT:   return %5 : $()                                 // id: %6
...
// CLIENT-COMMON-NEXT: // %0 "arg"                                       // users: %2, %1
// CLIENT-COMMON-NEXT: bb0(%0 : $*any PublicProto):
// CLIENT-COMMON-NEXT:   debug_value %0 : $*any PublicProto, let, name "arg", argno 1, expr op_deref // id: %1
// CLIENT-COMMON-NEXT:   %2 = open_existential_addr immutable_access %0 : $*any PublicProto to $*@opened({{.*}}, any PublicProto) Self // users: %6, %5, %4, %3
// CLIENT-COMMON-NEXT:   %3 = alloc_stack $@opened("{{.*}}", any PublicProto) Self // type-defs: %2; users: %8, %7, %6, %4
// CLIENT-COMMON-NEXT:   copy_addr %2 to [init] %3 : $*@opened("{{.*}}", any PublicProto) Self // id: %4
// CLIENT-COMMON-NEXT:   %5 = witness_method $@opened("{{.*}}", any PublicProto) Self, #PublicProto.data!getter : <Self where Self : Utils.PublicProto> (Self) -> () -> Int, %2 : $*@opened("{{.*}}", any PublicProto) Self : $@convention(witness_method: PublicProto) <τ_0_0 where τ_0_0 : PublicProto> (@in_guaranteed τ_0_0) -> Int // type-defs: %2; user: %6
// CLIENT-COMMON-NEXT:   %6 = apply %5<@opened("{{.*}}", any PublicProto) Self>(%3) : $@convention(witness_method: PublicProto) <τ_0_0 where τ_0_0 : PublicProto> (@in_guaranteed τ_0_0) -> Int // type-defs: %2; user: %9
// CLIENT-COMMON-NEXT:   destroy_addr %3 : $*@opened("{{.*}}", any PublicProto) Self // id: %7
// CLIENT-COMMON-NEXT:   dealloc_stack %3 : $*@opened("{{.*}}", any PublicProto) Self // id: %8
// CLIENT-COMMON-NEXT:   return %6 : $Int                                // id: %9
...
// CLIENT-COMMON-NEXT:   debug_value %0 : $*any PkgProto, let, name "arg", argno 1, expr op_deref // id: %1
// CLIENT-COMMON-NEXT:   %2 = open_existential_addr immutable_access %0 : $*any PkgProto to $*@opened("{{.*}}", any PkgProto) Self // users: %6, %5, %4, %3
// CLIENT-COMMON-NEXT:   %3 = alloc_stack $@opened("{{.*}}", any PkgProto) Self // type-defs: %2; users: %8, %7, %6, %4
// CLIENT-COMMON-NEXT:   copy_addr %2 to [init] %3 : $*@opened("{{.*}}", any PkgProto) Self // id: %4
// CLIENT-COMMON-NEXT:   %5 = witness_method $@opened("{{.*}}", any PkgProto) Self, #PkgProto.data!getter : <Self where Self : Utils.PkgProto> (Self) -> () -> Int, %2 : $*@opened("{{.*}}", any PkgProto) Self : $@convention(witness_method: PkgProto) <τ_0_0 where τ_0_0 : PkgProto> (@in_guaranteed τ_0_0) -> Int // type-defs: %2; user: %6
// CLIENT-COMMON-NEXT:   %6 = apply %5<@opened("{{.*}}", any PkgProto) Self>(%3) : $@convention(witness_method: PkgProto) <τ_0_0 where τ_0_0 : PkgProto> (@in_guaranteed τ_0_0) -> Int // type-defs: %2; user: %9
// CLIENT-COMMON-NEXT:   destroy_addr %3 : $*@opened("{{.*}}", any PkgProto) Self // id: %7
// CLIENT-COMMON-NEXT:   dealloc_stack %3 : $*@opened("{{.*}}", any PkgProto) Self // id: %8
// CLIENT-COMMON-NEXT:   return %6 : $Int                                // id: %9
